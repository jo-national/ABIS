...
def main() -> None:
    ...
    UDBYDER_REGLER = [
        ...
        ("Julius Baer",     ["JULIUS BAER", "JULIUS BÄR"]),
        ("GAM",             ["MULTICOOPERATION", " GAM "]),  # Multicooperation SICAV = GAM-paraply
        ("Polar Capital",   ["POLAR CAPITAL"]),
        ("Stewart Investors", ["STEWART INVESTORS"]),
        ("Baillie Gifford", ["BAILLIE GIFFORD"]),
        ("First Trust",     ["FIRST TRUST"]),
        ("UBP",             ["UBAM", "UNION BANCAIRE"]),
        ("FSSA",            ["FSSA"]),
        ("Skagen",          ["SKAGEN"]),
        ("Storebrand",      ["STOREBRAND"]),
        ("Montanaro",       ["MONTANARO"]),
        ("Harrington Cooper", ["HARRINGTON COOPER"]),
        ("GIB AM",          ["GIB AM"]),
        ("Wealth Invest",   ["WEALTH INVEST"]),
        ...
        ("C WorldWide",     ["C WORLDWIDE"]),
        ("Formuepleje",     ["FORMUEPLEJE"]),
        ("Nykredit",        ["NYKREDIT"]),
        ("Jyske Invest",    ["JYSKE"]),
        ("Grünbaum",        ["GRÜNBAUM", "GRUNBAUM"]),
    ]
