# Aktiebaseret? — opslagsværktøj for Skattestyrelsens ABIS-liste
...
5. Fejler noget — siden er nede, linket er væk, strukturen er ændret — fejler
   jobbet højlydt, du får en mail fra GitHub, og sitet forbliver på seneste
   gode version. Gamle data præsenteres aldrig som friske: kontroldatoen i
   sidens statuslinje opdateres kun ved succesfuld kørsel.
...
| Post | Pris |
|---|---|
| Domæne (.dk) | ca. 71–110 kr./år |
| Hosting (GitHub Pages) | 0 kr. |
| Automatisering (GitHub Actions, offentligt repo) | 0 kr. |
| **I alt** | **under 10 kr./md.** |

## Drift

- **Ny listeversion:** sker automatisk. Committen "Data: ny ABIS-listeversion…"
  i historikken viser hvornår; `data/parse_report.txt` viser hvad der blev læst.
- **Fejl:** GitHub mailer dig, når et workflow fejler. Kig i loggen; de tre
